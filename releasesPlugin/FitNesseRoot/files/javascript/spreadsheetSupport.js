...
title =
"This function will convert the text from spreadsheet format to FitNesse format.";

document.write("<input type='button' value='Spreadsheet to FitNesse' onClick='SelectionSpreadsheetToWiki(document.f.pageContent)' title='" +
               title + "'>");
document.write("&nbsp;");

title =
"This function will convert the text from FitNesse format to spreadsheet.";
